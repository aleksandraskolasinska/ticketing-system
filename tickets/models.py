...
class Ticket(models.Model):
    ...
    assignee = models.ForeignKey(User, on_delete=models.SET_NULL, blank=True, null=True, limit_choices_to={'is_staff': True}, related_name="%(app_label)s_%(class)s_created_tickets")#limit_choices_to={'is_staff': True}
